...
export default function TwinWidget({ twinId }: TwinWidgetProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="text-center space-y-2">
        ...
        <p className="text-slate-900 dark:text-slate-100 font-mono text-xs transition-colors duration-300">
          {twinId ? twinId.substring(0, 12) + '...' : 'Loading...'}
        </p>
      </div>
