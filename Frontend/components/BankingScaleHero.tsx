      ...
      <div className="mx-auto max-w-7xl px-8 py-24 pt-16">
        <div className="grid grid-cols-12 gap-5 gap-y-16">
          <div className="col-span-12 md:col-span-6 relative z-10">
            ...
            >
              Millions of AI Digital Twins networking continuously{" "}
              <span
              ...
              >
                to discover meaningful human connections before you ever start a conversation.
              </span>
            </h2>
            ...
            >
              As the first AI Digital Twin Network, we analyze personality, values, and compatibility to find the connections that matter most—for dating, friendship, business, and beyond.
            </p>
