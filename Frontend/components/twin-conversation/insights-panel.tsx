...
const insights = [
  "Your Twin noticed both users enjoy deeper conversations over casual small talk.",
  "Both users value trust and authenticity over physical appearance.",
  "Strong alignment detected in future goals—both prioritize personal growth and long-term commitment.",
  "Communication patterns suggest both users prefer meaningful, thoughtful exchanges.",
  "Lifestyle analysis shows compatible daily routines and work-life balance preferences.",
]
    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 py-3 rounded-lg bg-muted/20 border border-border/30">
        ...
        <span className="text-xs font-medium text-muted-foreground">
          {insights.length} deep insights generated by your Twin AI
        </span>
      </div>
    </motion.div>
  )
