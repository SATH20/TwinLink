...
const reasoningCategories = [
  { name: "Shared Values", score: 95, color: "#156d95" },
  { name: "Communication Style", score: 91, color: "#8b5cf6" },
  { name: "Lifestyle", score: 88, color: "#0ea5e9" },
  { name: "Goals", score: 97, color: "#10b981" },
  { name: "Interests", score: 93, color: "#f59e0b" },
]

export function AIReasoningPanel() {
  const averageScore = Math.round(
    reasoningCategories.reduce((acc, curr) => acc + curr.score, 0) /
      reasoningCategories.length
  )
        ...
        <div className="relative w-[120px] h-[120px] flex items-center justify-center">
          <svg className="w-full h-full -rotate-90 transform" viewBox="0 0 120 120">
            ...
            <motion.circle
              ...
              animate={{
                strokeDashoffset:
                  circumference - (averageScore / 100) * circumference,
              }}
