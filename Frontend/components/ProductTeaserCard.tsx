...
export const ProductTeaserCard = (props: ProductTeaserCardProps) => {
  const {
    ...
    dailyVolumeLabel = "AI DIGITAL TWINS ACTIVE",
    headline = "Your AI Digital Twin. Finding Meaningful Connections Before You Say Hello.",
    subheadline = "TwinLink creates an AI version of you that explores the network, talks with other Digital Twins, and recommends the people you're most likely to connect with.",
    description = "Trusted by people seeking authentic connections, TwinLink matches based on personality, values, and goals — with privacy-first AI that learns from every interaction.",
    ...
    primaryButtonText = "Create Your Twin",
    primaryButtonHref = "",
